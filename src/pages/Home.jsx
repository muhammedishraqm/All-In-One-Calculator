        ...
        <div className="max-w-7xl mx-auto space-y-12 animate-fade-in pb-12">
            ...
            <section className="px-4 md:px-0">
                <div className="flex items-center gap-3 mb-8">
                    <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-100">All Calculators</h2>
                    ...
                    {CALCULATORS.map((calc, idx) => {
                        ...
                        return (
                            <NavLink
                                key={calc.id}
                                to={calc.path}
                                className="group card p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden"
